...
import com.readboy.mydmeoforlib.bean.CompositeIndexBean;
import com.readboy.mydmeoforlib.bean.IncomeBean;
import com.readboy.mydmeoforlib.bean.LineChartBean;
import com.readboy.mydmeoforlib.manage.LineChartManager;
import com.readboy.mydmeoforlib.utils.LocalJsonAnalyzeUtil;
...
public class LineChartActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        lineChartManager1.addLine(GEM, "深证指数", getResources().getColor(R.color.RED));
